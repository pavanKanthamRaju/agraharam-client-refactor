...
import { getAllNivedyams } from "../api/dashboardsApi";
...
const BuyNivedyamPage = () => {
  ...
  const filteredNivedyams = nivedyams.filter((item) =>
  ...
  const handleCheckout = () => {
    ...
    const checkoutData = {
      poojaId: null,
      poojaName: "Nivedyam Purchase",
      description: "Standalone purchase of selected Nivedyam offerings.",
      price: 0,
      nivedyamCost: cartTotal,
      totalPrice: cartTotal,
      nivedyams: cartArray.map((item) => ({
        id: item.id,
        name: item.name,
    ...
    navigate("/nivedyam-order-review");
  };
  ...
  return (
    <div className="min-h-screen bg-[#fffaf0] py-6 px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-8 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-6 md:p-8 text-white shadow-lg relative overflow-hidden">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold mb-2">Order Nivedyam</h1>
        <p className="text-sm md:text-base text-orange-55 max-w-xl">
          Order sacred Nivedyam offerings and prasadams independently. Prepared with devotion and hygiene for your prayers.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="flex-1 w-full">
          ...
          <div className="mb-6 relative">
            ...
            <input
              type="text"
              placeholder="Search Nivedyams by name..."
              value={searchQuery}
          ...
          {filteredNivedyams.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-2xl border border-orange-100 shadow-sm">
              <p className="text-gray-500 text-lg">No Nivedyams match your search.</p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="p-5 flex flex-col flex-grow">
                      ...
                      <p className="text-sm text-gray-600 mb-4 line-clamp-2 min-h-[40px]">
                        {item.description || "Fresh and holy prasadam offering."}
                      </p>
...
export default BuyNivedyamPage;
