...
const PoojaNivedyamsModal = ({ isOpen, onClose, onConfirm, items, initialSelectedItems }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden animate-fade-in-up">
                ...
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-orange-50">
                    <div>
                        <h2 className="text-2xl font-bold text-orange-800">Select Nivedyam Offerings</h2>
                        <p className="text-sm text-gray-600 mt-1">Select holy sweet offerings and prasadam for your Pooja</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 scrollbar-thin scrollbar-thumb-orange-200 scrollbar-track-transparent">
                                ...
                                >
                                    ...
                                    <div className="ml-4 flex-1 pr-6">
                                        ...
                                        <p className="text-sm text-gray-500 mt-0.5">
                                            {item.quantity} {item.units || item.unit || "PCS"}
                                        </p>
                    ...
                    {items.length === 0 && (
                        <div className="text-center py-12 text-gray-500">
                            No Nivedyam offerings mapped to this Pooja.
                        </div>
                    )}
                </div>
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50 flex justify-end gap-3 rounded-b-xl">
                    ...
                    >
                        Add Selected Nivedyams ({localSelectedItems.length})
                    </button>
                </div>
            </div>
        </div>
...
export default PoojaNivedyamsModal;
